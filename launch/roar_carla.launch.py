...
def generate_launch_description():
    ...
    base_path = os.path.realpath(get_package_share_directory('roar_carla_ros2')) # also tried without realpath
    ...
    ld = launch.LaunchDescription([
        ...
        launch.actions.DeclareLaunchArgument(
            ...
            default_value='spawn_point_hero0'
        ),
        launch.actions.DeclareLaunchArgument(
            name='town',
            default_value='Carla/Maps/Town04'
        ),
        launch.actions.DeclareLaunchArgument(
            name='passive',
            default_value='False'
        ...
        launch.actions.DeclareLaunchArgument(
            ...
            default_value=vehicle_config_path
        ),
        launch.actions.DeclareLaunchArgument(
            name='role_name',
            default_value='ego_vehicle'
